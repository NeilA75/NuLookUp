...
exports.getAmazonProductPrices = getAmazonProductPrices;
 ...
 */
async function scrapeAmazonProductPage(query) {
 ...
 */
async function fetchFromKeepaApi(query, apiKey) {
    if (!apiKey) {
        return [];
    }
    try {
 ...
 */
async function getAmazonProductPrices(query) {
    try {
