...
exports.getGenericProductPrices = getGenericProductPrices;
 ...
 */
async function scrapeEbayGeneric(query) {
...
async function scrapeAmazonGeneric(query) {
    const page = await (0, scraperClient_1.getPage)();
    try {
...
async function scrapeEtsyGeneric(query) {
    const page = await (0, scraperClient_1.getPage)();
    try {
 ...
 */
async function getGenericProductPrices(query) {
    try {
